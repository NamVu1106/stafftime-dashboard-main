...
export const hrMenu: MenuTreeItem[] = [
  ...
  { id: 'reports-period', label: 'Báo cáo theo ngày / tuần / tháng', labelKey: 'deptMenu.reportsPeriod', icon: Calendar },
  ...
  { id: 'payroll-kpi', label: 'Báo cáo KPI', labelKey: 'deptMenu.payrollKpi', icon: BarChart3 },
  { id: 'workforce-summary', label: 'Tổng hợp nhân lực', labelKey: 'deptMenu.workforceSummary', icon: Users },
...
export const HR_REPORT_INLINE_IDS = new Set([
  ...
  'weekly-one-day-workers', 'daily-wage', 'labor-rate', 'bhxh-list', 'payroll', 'payroll-kpi', 'workforce-summary', 'drug-inventory',
...
export const hrMenuRoute: Record<string, string> = {
  ...
  'payroll': '/hr/payroll',
  'payroll-kpi': '/hr/payroll-kpi',
  'workforce-summary': '/hr/workforce-summary',
