        ...
        <Card className="lg:col-span-2">
          ...
          <CardContent className="space-y-4">
            <div className="space-y-2">
              <Label htmlFor={`hr-file-${reportKey}`}>File Excel</Label>
              <Input
                id={`hr-file-${reportKey}`}
                type="file"
                accept=".xlsx,.xls"
            ...
            {statsOverall ? (
              ...
              <>
                ...
                <div>
                  ...
                  {statsMedical.money.sum != null ? formatNumberPlain(statsMedical.money.sum) : '—'}
                </div>
                <div>
                  <span className="font-medium">Tổng người:</span>{' '}
                  {statsMedical.people?.sum != null ? formatNumberPlain(statsMedical.people.sum) : '—'}
                </div>
                <div>
                  <span className="font-medium">Max tỉ lệ(%):</span>{' '}
                  {statsMedical.rate?.max != null ? `${statsMedical.rate.max}%` : '—'}
                </div>
              </>
            ) : statsDrug ? (
              <>
              ...
              <>
                ...
                <div>
                  ...
                  {statsDailyWage.grandTotal != null ? formatNumberPlain(statsDailyWage.grandTotal) : '—'}
                </div>
              </>
            ) : statsTotalRow ? (
              <>
